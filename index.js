...
(function($PS) {
  ...
  var apiHandler = Node_Express_Response.sendJson({
      message: "Hello from the API!"
  });
  var app = Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.use(Node_Express_Middleware_Static["static"]("./client/build")))(function () {
      return Node_Express_App.get()("/api")(apiHandler);
  });
  var main = Node_Express_App.listenHttp(app)(5000)(function (v) {
      return Effect_Console.log("Listening on " + Data_Show.show(Data_Show.showInt)(5000));
  });
